...
declare global {
  ...
  const useRapportGenerator: typeof import('../../composables/useRapportGenerator').useRapportGenerator
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { Foto, Bevinding, Pentester, TestSoort, Report, DbBevinding, User } from '../../composables/useReports'
  import('../../composables/useReports')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useRapportGenerator: UnwrapRef<typeof import('../../composables/useRapportGenerator')['useRapportGenerator']>
